...
-- Script date 2/3/2020 10:42:44 PM
...
CREATE TABLE ft_loan (
  ...
  LOAN_INT_RATE_KEY INT(11) DEFAULT NULL,
...
--
-- Create index `FK_ft_loan_dim_country_GUARANTOR_COUNTRY_KEY` on table `ft_loan`
--
ALTER TABLE ft_loan 
...
--
ALTER TABLE ft_loan 
  ADD CONSTRAINT FK_ft_loan_dim_loan_interest_rates_LOAN_INT_RATE_KEY FOREIGN KEY (LOAN_INT_RATE_KEY)
    REFERENCES dim_loan_interest_rates(LOAN_INT_RATE_KEY) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Table wb.dim_time does not contain any data (it is empty)
...
--
-- Table wb.dim_currency does not contain any data (it is empty)
...
-- 
-- Dumping data for table ft_loan
--
-- Table wb.ft_loan does not contain any data (it is empty)
